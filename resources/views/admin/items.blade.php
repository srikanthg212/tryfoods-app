         ...
         <div class="content-wrapper">
            ...
            <div class="row">
               <div class="col-xl-6">
                    ...
                    <form id="itemsAddForm" action="{{ route('items.store') }}" data-parsley-validate="" method="POST">
                    @csrf
                        <!-- START card-->
                        <div class="card card-default">
                            <div class="card-header">
                            <div class="card-title">Base add-ons</div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="col-form-label"> Item Qty *</label>
                        ...
                        <div class="card-footer">
                           <div class="clearfix">
                              <div class="float-right"><button class="btn btn-primary" type="submit"> Submit </button></div>
                           </div>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabelLarge">Edit Base Item</h4><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                </div>
